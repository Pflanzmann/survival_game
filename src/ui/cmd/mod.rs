        ...
        app
            ...
            .add_system_set(
                SystemSet::on_update(ConsoleState::Shown)
                    ...
                    .with_system(assign_bullet_attribute_value_system::<Damage, BulletDamageText>)
                    .with_system(assign_bullet_attribute_value_system::<MoveSpeed, BulletMoveSpeedText>)
                    .with_system(assign_bullet_attribute_value_system::<UnitSize, BulletUnitSizeText>)
                    .with_system(assign_bullet_attribute_value_system::<TravelRange, BulletTravelRangeText>)
                    .with_system(assign_bullet_attribute_value_system::<HitLimit, BulletHitLimitText>)
            )
        ;
    }
}
