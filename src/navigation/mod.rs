...
use crate::navigation::stage_label_system::{collision_label_system, first_label_system, last_label_system, post_update_label_system, pre_update_label_system, update_label_system};
...
impl Plugin for NavigationPlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_system(last_label_system.label(ScheduleLabel::Last).after(ScheduleLabel::PostUpdate))
