...
use crate::components::unit_stats_components::{FacingDirection, Enemy, MoveSpeed};

pub fn enemy_movement_system(
    mut enemies: Query<(&mut Transform, &MoveSpeed, &mut FacingDirection), (With<Enemy>, Without<Player>)>,
